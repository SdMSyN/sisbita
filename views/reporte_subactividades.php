      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="reporte_subactividades.php">Subactividades</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h1 class="page-header">Reporte Subactividades</h1>
		...
		$(document).ready(function(){
			$("#fechas").click(function(){
				...
				$.ajax({
				   ...
				   url: "../controllers/get_subactividades_date_range.php",
				   success: function(msg){
					   ...
					   if(msg.error == 0){
							...
							$.each(msg.dataRes, function(i, item){
								var newRow = '<tr>'
									+'<td>'+msg.dataRes[i].nameSubAct+'</td>'
									+'<td>'+msg.dataRes[i].numSubAct+'</td>'
									+'</tr>';
								$(newRow).appendTo("#data tbody");
								suma += parseInt(+msg.dataRes[i].numSubAct);
								nombres[i] = msg.dataRes[i].nameSubAct;
								totales[i] = parseInt(msg.dataRes[i].numSubAct);
							});
							//Totales
